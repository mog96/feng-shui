...
void setup()
{
  ...
  // Map multiple 60-LED strips.
  for (int i = 0; i < numStrips; i++) {
    // Horizontal layout.
    opc.ledStrip(i * 180, 180, width / 2, i * height / numStrips + (height / numStrips / 2), 2, 0, false);
    
    // Vertical layout.
    // opc.ledStrip(i * 60, 60, i * width / numStrips + (width / numStrips / 2), height / 4, 5, HALF_PI, false);
  }
...
void draw()
{
  ...
  src.directionalLight(0, 0, 255, 1, 0, 0);
